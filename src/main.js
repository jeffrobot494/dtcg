...
import { RecipesScene } from './scenes/RecipesScene.js';
...
sm.register('recipes',  'Recipes', (root, mgr, ctx) => new RecipesScene(root, mgr, ctx));
// Camp, Merchant, Crafting, and GameOver are sub-scenes reached only via
// in-game navigation; they stay off the nav bar.
...
sm.registerHidden('crafting', (root, mgr, ctx) => new CraftingScene(root, mgr, ctx));
